...
@interface WOCBuyingWizardOfferListViewController () <UITableViewDelegate, UITableViewDataSource>
...
@implementation WOCBuyingWizardOfferListViewController
...
- (void)pushToStep6:(NSInteger)sender {
    ...
    WOCBuyingWizardInputEmailViewController *inputEmailViewController = (WOCBuyingWizardInputEmailViewController*)[self getViewController:@"WOCBuyingWizardInputEmailViewController"];
                ...
                if (orders.count > 0) {
                    ...
                    if (wdArray.count > 0) {
                        ...
                        if ([status isEqualToString:@"WD"]) {
                            WOCBuyingInstructionsViewController *instructionsViewController = [self getViewController:@"WOCBuyingInstructionsViewController"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.orderButton addTarget:self action:@selector(onOrderButtonClicked:) forControlEvents:UIControlEventTouchUpInside];
